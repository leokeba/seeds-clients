...
class TestModelGardenClientParseResponse:
    ...
    def test_parse_response_stores_codecarbon_metadata(self, client, sample_response_with_codecarbon):
        ...
        assert metrics["session_total_kg_co2"] == pytest.approx(0.0005, rel=1e-3)  # 0.5g -> 0.0005kg
...
class TestModelGardenClientIntegration:
    ...
    def client(self, tmp_path):
        """Create a Model Garden client instance."""
        return ModelGardenClient(cache_dir=str(tmp_path / "cache"))
